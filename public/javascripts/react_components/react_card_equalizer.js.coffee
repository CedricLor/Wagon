class window.ReactCardEqualizer
  ReactCSSTransitionGroup = React.addons.CSSTransitionGroup
  DOM = React.DOM

  constructor: (react_target, localizedReadMore, colClasses, clearFixClassesForTwoCards, clearFixClassesForThreeCards, clearFixClassesForFourCards, sourceDomElements) ->
    card_container = React.createElement CardContainer,
      domElements: sourceDomElements
      localizedReadMore: localizedReadMore
      colClasses: colClasses
      clearFixClassesForTwoCards: clearFixClassesForTwoCards
      clearFixClassesForThreeCards: clearFixClassesForThreeCards
      clearFixClassesForFourCards: clearFixClassesForFourCards
